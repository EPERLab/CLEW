...
file_name = './2_Model/'+sce+'/ModeloEnergia_'+ sce +'.xlsx'

#Leer cada una de las hojas del archivo
xl = pd.ExcelFile(file_name)
sheets = xl.sheet_names

#sheets_list = ['AvailabilityFactor','CapacityFactor','CapacityToActivityUnit','CapitalCost','EmissionActivityRatio','EmissionsPenalty','FixedCost', 'InputActivityRatio','OperationalLife','OutputActivityRatio','ResidualCapacity','SpecifiedAnnualDemand','SpecifiedDemandProfile','TotalAnnualMaxCapacity','TotalAnnualMinCapacityInvestmen','TotalTechnologyAnnualActivityLo','TotalTechnologyAnnualActivityUp','VariableCost','YearSplit']
sheets_list = [
 'AvailabilityFactor',
 #'CapacityFactor',
...
struc_model = pd.read_excel(io=file_name, sheet_name='Sets_Energy')
# %%
...
file_table1 = './0_Ref/STRUCTURE_OSEMOSYS_CR_ENERGY.xlsx'
file_txt = './0_Ref/data_energy.txt'
...
g= open( './2_Model/' + sce + '/data_energy' + '.txt',"w+")
g.write( '###############\n#    Sets     #\n###############\n#\n' )

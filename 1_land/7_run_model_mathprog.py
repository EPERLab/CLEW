...
def set_txt_list( model_to_run ):
    ...
    for e in range( len( txt_list ) ):
        structural_list.append( 'STRUCTURE_OSEMOSYS_CR_LAND.xlsx' )
...
def data_processor( case, model_to_run_gen, sce_gen ):
    ...
    if model_to_run_gen == 'land' and sce_gen == 'BAU':
        ini_line = 3158666+2
        end_line = 6288376
    
    if model_to_run_gen == 'land' and sce_gen == 'SR15':
        ini_line = 3158666+2
        end_line = 6288376
    
    if model_to_run_gen == 'land' and sce_gen == 'SCE':
        ini_line = 3158666+2
        end_line = 6288376
    #

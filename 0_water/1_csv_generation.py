...
file_name = './2_Model/'+sce+'/ModeloAgua_'+ sce +'.xlsx'
...
struc_model = pd.read_excel(io=file_name, sheet_name='Sets_Water')
...
file_table1 = './0_Ref/STRUCTURE_OSEMOSYS_CR_WATER.xlsx'
file_txt = './0_Ref/data_water.txt'
...
g= open( './2_Model/' + sce + '/data_water' + '.txt',"w+")
g.write( '###############\n#    Sets     #\n###############\n#\n' )
